...
def run_pipeline(owner: str, repo_name: str, alert: dict, log_callback=None) -> dict:
    ...
    try:
        ...
        print(f"[tokens] usage_metrics value: {crew.usage_metrics}")
        ...
        try:
            ...
            if usage:
                ...
                print(
                    f"[tokens] input={input_tokens} output={output_tokens} cost=${cost:.4f}"
                )
        except Exception as e:
            print(f"[tokens] could not read usage_metrics: {e}")
            token_usage = {
                "input_tokens": 0,
                "output_tokens": 0,
                "total_tokens": 0,
...
if __name__ == "__main__":
    ...
    result = run_pipeline(owner, repo, critical)
